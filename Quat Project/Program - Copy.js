...
function CombineAxes()
{
    ...
    //console.log(a1, " : ", b1);
    /*
    if((-.001 < a1 && a1 < .001) || (-.001 < b1 && b1 < .001))
    {
        console.log(rotAxis[0]); rotAxis[0]= rotAxis[0] * -1; console.log(rotAxis[0]);
        console.log(rotAxis[1]); rotAxis[1]= rotAxis[1] * -1; console.log(rotAxis[1]);
        console.log(rotAxis[2]); rotAxis[2]= rotAxis[2] * -1; console.log(rotAxis[2]);
    }
    */
}
